            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="user" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="{{ route('profil_admin') }}" class="sidebar-link">Profile Detail</a>
                        </li>
                        <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('dukpro.index') }}" class="sidebar-link">
                        <i class="lni lni-agenda"></i>
                ...
                <li class="sidebar-item">
                    <a href="{{ route('index_resep') }}" class="sidebar-link">
                        <i class="lni lni-agenda"></i>
                ...
                <li class="sidebar-item">
                    <a href="{{ route('create_BahanBaku') }}" class="sidebar-link">
                        <i class="lni lni-agenda"></i>
                ...
                <li class="sidebar-item">
                    <a href="{{ route('index_bahanBaku') }}" class="sidebar-link">
                        <i class="lni lni-agenda"></i>
                ...
                <li class="sidebar-item">
                    <a href="{{ route('hampers.index') }}" class="sidebar-link">
                        <i class="lni lni-agenda"></i>
                        <span>Data Hampers</span>
                    </a>
                </li>
                ...
                {{-- <li class="sidebar-item">
                    <a href="{{ route('edit_BahanBaku') }}" class="sidebar-link">
                        <i class="lni lni-agenda"></i>
