                        ...
                        <table class="table table-bordered table-striped" id="tx">
                            ...
                            <tbody>
                                ...
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->tanggal_income }}</td>
                                        <td>{{ $data->transaksi->no_transaksi }}</td>
                                        <td> Rp. {{ number_format($data->jumlah_income, 0, ',', '.') }}</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th id="total-amount">Rp. {{ number_format($datas->sum('jumlah_income'), 0, ',', '.') }}
                                    </th>
                                    <th></th>
                                </tr>
                            </tfoot>
