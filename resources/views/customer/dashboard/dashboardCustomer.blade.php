...
@section('content')
    <main>
        <article>
            <section class="hero" id="home" style="background-image: url('{{ asset('assets/images/bgcake2.jpg') }}');">
                <div class="container">
                    @if (session('error'))
                    ...
                    <div class="hero-content">
                        ...
                        <p class="hero-text">Nourishment encompasses any substance vital for sustaining life and vitality.
                        </p>
                        ...
                        @for ($i = 0; $i < 5; $i++)
                            <li class="promo-item">
                                <div class="promo-card">
                                    ...
                                    <img src="{{ asset('assets/images/tiramisuCake.png') }}" width="300" height="300"
            ...
            <section class="section section-divider gray about" id="about">
                <div class="container">
                    ...
                    <div class="about-banner">
                        <img src="{{ asset('assets/images/tiramisuCake.png') }}" width="559" height="550"
                            ...
                            <div class="col-10 date-picker">
                                <div class="form-group h-100">
                                    ...
                                    <input type="date" name="date-picker" id="date-picker"
                                        class="form-control form-control-lg" value="{{ $date ?? Date('Y-m-d') }}">
                                </div>
                            </div>
                            <div class="col-2">
                            ...
                            <li>
                                <div class="food-menu-card">
                                    <div class="card-banner">
                                        <img src="{{ asset('storage/dukpro/' . $item->image) }}" style="width: 300px;"
                                            loading="lazy" alt="cake" class="w-100">
            ...
            <section class="section section-divider gray delivery">
                <div class="container">
                    ...
                    <figure class="delivery-banner">
                        ...
                        <img src="{{ asset('/assets/images/delivery-boy.svg') }}" width="1000" height="880"
                    ...
                    <ul class="banner-list">
                        <li class="banner-item banner-lg">
                            <div class="banner-card">
                                <img src="{{ asset('image/banner-5.jpeg') }}" width="550" height="450"
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                <img src="{{ asset('image/banner-1.jpg') }}" width="550" height="465"
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                <img src="{{ asset('image/lastbanner.jpg') }}" width="550" height="465"
                        ...
                        <li class="banner-item banner-md">
                            <div class="banner-card">
                                <img src="{{ asset('image/banner-2.jpg') }}" width="550" height="220"
                        ...
                        <li class="testi-item">
                            <div class="testi-card">
                                ...
                                <div class="profile-wrapper">
                                    ...
                                    <figure class="avatar">
                                        <img src="{{ asset('/assets/images/avatar-1.jpg') }}" width="80"
                        ...
                        <li class="testi-item">
                            <div class="testi-card">
                                ...
                                <div class="profile-wrapper">
                                    ...
                                    <figure class="avatar">
                                        <img src="{{ asset('assets/images/avatar-2.jpg') }}" width="80"
                        ...
                        <li class="testi-item">
                            <div class="testi-card">
                                ...
                                <div class="profile-wrapper">
                                    ...
                                    <figure class="avatar">
                                        <img src="{{ asset('assets/images/avatar-3.jpg') }}" width="80"
